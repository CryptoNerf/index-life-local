...
<!-- SCREENSHOT: настройки кастомизации с живым предпросмотром | ../images/customization-settings.png -->
<!-- SCREENSHOT: до / после смены темы | ../images/customization-before-after.png -->
