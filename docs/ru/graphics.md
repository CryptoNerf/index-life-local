...
![график «overview»](../images/overview-graphic.png)
...
![график «river»](../images/river_of_mood-graphic.png)
...
![график «spiral»](../images/spiral_year-graphic.png)
...
![график «rose»](../images/rose-graphic.png)

Семь секторов — по дню недели (понедельник вверху). **Форма лепестка** — это распределение твоих оценок в этот день недели: вдоль сектора отложена шкала 1→10 (метки «1» и «10» есть на понедельничном лепестке), и где лепесток «раздувается» — там такие оценки встречались чаще; самый широкий выступ соответствует твоей типичной оценке для этого дня. Каждый лепесток нормирован по своему пику, поэтому все дотягиваются до одного внешнего радиуса — смотреть нужно не на общий размер, а на то, **где** находится выступ. **Насыщенность (цвет)** кодирует среднюю оценку дня недели относительно других дней: темнее = в среднем хуже, светлее = в среднем лучше (шкала подписана под графиком).

Как читать: по цвету — какой день недели для тебя в среднем лучше или хуже; по форме — где обычно держатся твои оценки в этот день и насколько они разбросаны. Наведение на лепесток показывает число записей и среднюю оценку.

---

## Хребты (месячные распределения) (ridgeline)

![график «ridgeline»](../images/ridgeline-graphic.png)
...
![график «rhythm»](../images/rhytm-graphic.png)
...
![график «words»](../images/recurring_words-graphic.png)
...
![график «activities»](../images/activities-graphic.png)
