...
- **Связи (линии)** соединяют темы, чьи смыслы близки. Порог невысокий, а модель считает большинство дневниковых тем довольно похожими — поэтому связей обычно много и почти все нейроны оказываются соединены. Воспринимай сеть как общий «фон связности», а не как точную карту близости.
