...
Локальный офлайн-дневник настроения, построенный вокруг одного ежедневного вопроса — **«Как прошёл мой день?»**
...
**index.life** — это приложение для ведения учёта настроения и заметок о днях.
Его главная цель проста: побудить человека каждый день задавать себе вопрос
*«Как прошёл мой день?»* — и записывать ответ. Я убеждён, что такая небольшая
ежедневная практика по-настоящему положительно влияет на жизнь. Ещё одна цель
index.life — архивировать данные о своём самочувствии и свои мысли, чтобы потом
к ним можно было вернуться.

Всё работает **локально и офлайн** — без аккаунтов, серверов и телеметрии.
Дневник остаётся на твоём устройстве.

## Что внутри

Помимо самого **календаря заметок** и **markdown-редактора**, index.life даёт
набор инструментов, поддерживающих эту привычку:

- 🧠 **AI-психолог** — чат с локальной языковой моделью, у которой есть доступ к
...
- 🌌 **Нейронная карта мыслей** — твои записи, собранные в темы, которые можно
  исследовать визуально. [Подробнее »](docs/ru/neural-map.md)
- 📊 **Графики**, визуализирующие разные аспекты самочувствия во времени.
  [Подробнее »](docs/ru/graphics.md)
- 🎨 **Кастомизация и синхронизация** — настрой внешний вид всего приложения и
  держи дневник в актуальном состоянии на всех устройствах.
  [Кастомизация »](docs/ru/customization.md) · [Синхронизация »](docs/ru/sync.md)

> **AI-психолог** и **нейронная карта** — опциональные модули, которые ставятся
> по желанию (один раз скачивается локальная модель). Календарь, редактор,
> графики, кастомизация и синхронизация встроены.
