...
4. **Важно!** При первом запуске macOS заблокирует приложение. Выполните одно из действий:

   **Способ 1 (проще):**
   - Найдите index.life в Applications
   - Нажмите **правой кнопкой** на приложение → **Открыть**
   ...
   **Способ 2 (через терминал):**
   ...
   После этого приложение будет запускаться как обычно.
