"""Promo motion graphics — AI Psychologist intro, x-ray variant (BACKUP).

Kept as a backup of an earlier take that the actual production scene
(ai_psychologist_intro.py) has replaced. Three layers (embeddings,
summaries, profile silhouette) blew up around the chat instead of
being drawn inside it. Keep around as inspiration / fallback.
...
Render:
    manim -qh promo/ai_psychologist_intro_xray.py AIPsychXRayIntro
    manim -qh promo/ai_psychologist_intro_xray.py AIPsychXRayIntroEN
"""
from manim import *
import numpy as np
...
class AIPsychXRayIntro(Scene):
    """Russian x-ray-variant backup (see top-of-file docstring).

    Render: manim -qh promo/ai_psychologist_intro_xray.py AIPsychXRayIntro
    """
    def construct(self):
        _render_chat(
            self,
...
class AIPsychXRayIntroEN(Scene):
    """English x-ray-variant backup.

    Render: manim -qh promo/ai_psychologist_intro_xray.py AIPsychXRayIntroEN
    """
    def construct(self):
        _render_chat(
            self,
